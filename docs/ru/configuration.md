...
| Настройки сервера | SSH по паролю/ключу с прямым root или sudo: список/создание/удаление, `fp-change`, `sni-change`, `port-change`, плюс обновление/удаление сервера |
